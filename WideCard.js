...
(function () {
    ...
    if (!$('style[data-id="mdblist_homepage_cards"]').length) {
        ...
        <style data-id="mdblist_homepage_cards">
            ...
            /* Container for Grid */
            .mdblist-ratings-wrapper { position: absolute; bottom: 0.5em; left: 1.5em !important; display: flex; flex-direction: row; flex-wrap: wrap; gap: 0.3em; z-index: 10; align-items: center; }
